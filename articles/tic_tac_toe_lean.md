...
:::message
この記事は、筆者が Lean by Example に投稿した記事 [三目並べ](https://lean-ja.github.io/lean-by-example/EXTRA/TicTacToe.html) のコピーです。Lean のバージョン更新などが行われるのは Lean by Example に投稿したほうです。
:::
...
これを素直に実装すると、[相互再帰関数](https://lean-ja.github.io/lean-by-example/Declarative/Mutual.html) になります。
